...
//
//  Created by Mihai Carabas on 24/09/2018.
//  Copyright © 2018 Brandon Azad. All rights reserved.
//

@interface SFRemoteInteractionSession : NSObject @end
@interface VD9LmqazgfzMqjuy : NSObject @end
@interface CSSpeechController : NSObject @end
@interface NSXPCCoder : NSObject @end
@interface CloudPushNotificationController : NSObject @end
@interface SAStructuredDictationResult : NSObject @end
@interface BKSTouchDeliveryPolicy : NSObject @end
@interface NRXPCProxy : NSObject @end
@interface GKChallengeInternal : NSObject @end
@interface CTCarrierSpaceDataPlanMetrics : NSObject @end
@interface VSPresynthesizedAudioRequest : NSObject @end
@interface CTCarrierSpaceCapabilities : NSObject @end
@interface AFMetrics : NSObject @end
@interface SFRequestMessage : NSObject @end
@interface FBSDisplayLayoutTransitionContext : NSObject @end
@interface AFAnalyticsEvent : NSObject @end
@interface SFService : NSObject @end
@interface AFAudioPlaybackRequest : NSObject @end
@interface SASPronunciationRecognized : NSObject @end
@interface CTCarrierSpaceUserConsentFlowInfo : NSObject @end
@interface CTCarrierSpacePlansInfo : NSObject @end
@interface NDBackgroundSession : NSObject @end
@interface IDSAccount : NSObject @end
@interface SFDevice : NSObject @end
@interface SFBLEDevice : NSObject @end
@interface UASharedPasteboardInfo : NSObject @end
@interface AFSpeechCorrectionInfo : NSObject @end
@interface TIImageCacheItem : NSObject @end
@interface ASDRequest : NSObject @end
@interface FPItem : NSObject @end
@interface FPSandboxingURLWrapper : NSObject @end
@interface INImage : NSObject @end
@interface WCMessage : NSObject @end
@interface SDStreamManager : NSObject @end
@interface MSPowerBudget : NSObject @end
@interface GKAchievementInternal : NSObject @end
@interface UAUserActivityInfo : NSObject @end
@interface INIntent : NSObject @end
@interface AFClientConfiguration : NSObject @end
@interface CXCall : NSObject @end
@interface CXCallObserver : NSObject @end
@interface NRRemoteObjectClassC : NSObject @end
@interface EPNanoRegistryStatusCodeElection : NSObject @end
@interface RPIOSurfaceObject : NSObject @end
@interface MLDMutableDiagnostic : NSObject @end
@interface EPDevice : NSObject @end
@interface GKFriendRequestInternal : NSObject @end
@interface ICPushNotificationMessage : NSObject @end
@interface APSIncomingMessage : NSObject @end
@interface VSSpeechRequest : NSObject @end
@interface NRRecoveryManager : NSObject @end
@interface VSVoiceAsset : NSObject @end
@interface GKGameInternal : NSObject @end
@interface SFResponseMessage : NSObject @end
@interface GKAuthenticateResponse : NSObject @end
@interface AceObject : NSObject @end
@interface VSVoiceResourceAsset : NSObject @end
@interface CBPeer : NSObject @end
@interface ML3MusicLibrary : NSObject @end
@interface SFCompanionService : NSObject @end
@interface GKCloudPlayer : NSObject @end
@interface CBScalablePipe : NSObject @end
@interface MCProfileConnection : NSObject @end
@interface AFSpeechPackage : NSObject @end
@interface APSConnection : NSObject @end
@interface ML3DatabaseImport : NSObject @end
@interface MIBundleMetadata : NSObject @end
@interface IDSDevice : NSObject @end
@interface SFDeviceDiscovery : NSObject @end
@interface GKGameSession : NSObject @end
@interface SDStreamHandler : NSObject @end
@interface CBCentralManager : NSObject @end
@interface AFAudioState : NSObject @end
@interface NRPairedSyncAdvisor : NSObject @end
@interface PSYSyncCoordinator : NSObject @end
@interface RTLocationOfInterest : NSObject @end
@interface AFSpeechSynthesisRecord : NSObject @end
@interface SFUserNotification : NSObject @end
@interface SASetApplicationContext : NSObject @end
@interface SASVoiceSearchFinalResult : NSObject @end
@interface FBSDisplayLayout : NSObject @end
@interface CSServerEndpointFeatures : NSObject @end
@interface MLDMediaLibraryWriter : NSObject @end
@interface CTCellularPlanItem : NSObject @end
@interface WCSessionUserInfoTransfer : NSObject @end
@interface AFXPCWrapper : NSObject @end
@interface CLLocation : NSObject @end
@interface RPRecordingSession : NSObject @end
@interface CSEndpointerMetrics : NSObject @end
@interface SASSpeechPartialResult : NSObject @end
@interface CBScalablePipeManager : NSObject @end
@interface APSOutgoingMessage : NSObject @end
@interface SASVoiceSearchPartialResult : NSObject @end
@interface SFCoordinatedAlertRequest : NSObject @end
@interface SSAuthenticateResponse : NSObject @end
@interface NRDeviceCollectionHistory : NSObject @end
@interface SFEventMessage : NSObject @end
@interface IDSSession : NSObject @end
@interface IDSService : NSObject @end
@interface SABaseCommand : NSObject @end
@interface NDApplication : NSObject @end
@interface AFVoiceInfo : NSObject @end
@interface NRMutableDeviceCollection : NSObject @end
@interface MSPauseManager : NSObject @end
@interface AFApplicationInfo : NSObject @end
@interface FPDProcessMonitor : NSObject @end
@interface SiriCoreLocalSpeechRecognizer : NSObject @end
@interface FPItemID : NSObject @end
@interface CBPeripheral : NSObject @end
@interface SSAuthenticateRequest : NSObject @end
@interface AFExperimentContext : NSObject @end
@interface CTCarrierSpaceAppsInfo : NSObject @end
@interface SFSession : NSObject @end
@interface MLDActiveTransaction : NSObject @end
@interface SDUnlockXPCSession : NSObject @end
@interface NRRemoteObjectCloud : NSObject @end
@interface UAPingResults : NSObject @end
@interface AFSpeechRequestOptions : NSObject @end
@interface SBSStatusBarStyleOverridesCoordinator : NSObject @end
@interface SDCompanionStream : NSObject @end
@interface NRLocalPropertyMonitor : NSObject @end
@interface PSYServiceSyncSession : NSObject @end
@interface TIKeyboardActivityContext : NSObject @end
@interface AFRequestInfo : NSObject @end
@interface INIntentResponse : NSObject @end
@interface AFSpeechRecognition : NSObject @end
@interface WCDPKClient : NSObject @end
@interface NRSwitchProgressTracker : NSObject @end
@interface ML3DatabaseConnection : NSObject @end
@interface ML3LanguageResources : NSObject @end
@interface SFCompanionAdvertiser : NSObject @end
@interface NRDeviceCollectionDiff : NSObject @end
@interface CTCarrierSpaceAuthInfo : NSObject @end
@interface ADAcousticFingerprinter : NSObject @end
@interface VSInstrumentMetrics : NSObject @end
@interface SFAppleIDAccount : NSObject @end
@interface CBPairingAgent : NSObject @end
@interface SDConnectionManager : NSObject @end
@interface WCSessionFileTransfer : NSObject @end
@interface FBSDisplayLayoutMonitor : NSObject @end
@interface AFDictationOptions : NSObject @end
@interface CTCarrierSpaceUsageInfo : NSObject @end
@interface GKScoreInternal : NSObject @end
@interface SASPronunciationContext : NSObject @end
@interface SASSpeechRecognized : NSObject @end
@interface NRRemoteObjectClassD : NSObject @end
@interface CTCarrierSpacePlanGroupOptionInfo : NSObject @end
@interface IDSProtobuf : NSObject @end
@interface NRSecureDevicePropertyStore : NSObject @end
@interface IDSMessageContext : NSObject @end
@interface ENGroup : NSObject @end
@interface CTCarrierSpaceClientProxy : NSObject @end
@protocol SFActivityAdvertiserProtocol <NSObject> @end
@protocol SBSStatusBarTapContext <NSObject> @end
@protocol NDBackgroundSessionProtocol <NSObject> @end
@protocol SFRemoteHotspotClient <NSObject> @end
@protocol SAAceCommand <NSObject> @end
@protocol ASDRequestDelegate <NSObject> @end
@protocol SFUnlockProtocol <NSObject> @end
@protocol NSSecureCoding <NSObject> @end
@protocol FPDRemoteFileProvider <NSObject> @end
@protocol ADAudioStateAnnouncing <NSObject> @end
@protocol NRRecoveryManagerStepDelegate <NSObject> @end
@protocol CSEndpointAnalyzer <NSObject> @end
@protocol SFContinuityScannerClient <NSObject> @end
@protocol SFCompanionServiceManagerClient <NSObject> @end
@protocol SFCompanionServiceManagerProtocol <NSObject> @end
@protocol ASDRequestProxy <NSObject> @end
@protocol SFContinuityScannerProtocol <NSObject> @end
@protocol EPResourceProtocol <NSObject> @end
@protocol SFRemoteHotspotProtocol <NSObject> @end
@protocol OS_dispatch_queue <NSObject> @end
@protocol NDBackgroundSessionClient <NSObject> @end
@protocol SFActivityAdvertiserClient <NSObject> @end
@protocol ADSpeechCapturingDelegate <NSObject> @end
@protocol FPDRemoteServiceEndpointCreatingProvider <NSObject> @end
